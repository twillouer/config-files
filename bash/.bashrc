...
#export M2_HOME=/usr/local/java/apache-maven-2
[[ $- == *i* ]] && . ~/git-prompt.sh

#alias mvn=/usr/local/bin/mvnc
...
#BASE_PS1=$PS1
#GIT_PS1='[\[\033[1;35m\]\W$(__git_ps1 " \[\033[1;34m\](%s)")\[\033[0m\]]\$ '
#GITPROMPT='{ if [[ -d .git ]]; then export PS1=$GIT_PS1; else export PS1=$BASE_PS1; fi; } 2>/dev/null'
#
#if [[ ! $PROMPT_COMMAND =~ __git_ps1 ]]; then
#    export PROMPT_COMMAND="${PROMPT_COMMAND:-:} && $GITPROMPT"
#fi
